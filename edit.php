...
<body class="h-screen flex-row items-center justify-center bg-gray-100">
    <div class="container mx-auto max-w-xl p-8 bg-white rounded shadow-lg">
        <div class="flex items-center justify-between pb-6">
            <div>
                <h4 class="text-xl font-bold mb-4">Update Student</h4>
            </div>
        ...
        ?>
        <?php
        $getStudent = $re->getStudentById($id);
        if ($getStudent) {
            while ($row = mysqli_fetch_assoc($getStudent)) {
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="m-10 max-w-sm">
                        ...
                        <img src="<?= $row["photo"] ?>" style="width: 400px" alt="<?= $row["name"] ?>">
                    ...
                    <div class="m-10 max-w-sm">
                        ...
                        <div class="relative">
                            <textarea id="address" name="address"
                                class="block w-full rounded-md border border-gray-200 py-3 px-4 pr-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"><?= $row["address"] ?></textarea>
                        </div>
                    </div>
